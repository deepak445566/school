...
const FloraWingsOnePage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-amber-50 via-white to-blue-50 exo">
      ...
      <div className="relative bg-gradient-to-r from-emerald-800 via-teal-700 to-emerald-800 text-white overflow-hidden">
        ...
        <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-12 sm:py-16 md:py-14">
