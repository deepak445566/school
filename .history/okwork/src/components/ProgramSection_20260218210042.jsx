...
import program1 from '/public/images/program1.png';
import program2 from '/public/images/program2.png';
import program3 from '/public/images/program3.png';
import program4 from '/public/images/program4.png';
import top from '/public/images/top-pattern.png';
import bot from '/public/images/bottom-pattern.png';
        ...
        {[ 
          ...
          >
            ...
            <img 
              src={top} 
              alt="" 
              className="absolute top-0 left-0 w-16 md:w-20 opacity-40 group-hover:opacity-60 transition-opacity pointer-events-none"
            />
            <img 
              src={bot} 
              alt="" 
              className="absolute bottom-0 right-0 w-16 md:w-20 opacity-40 group-hover:opacity-60 transition-opacity pointer-events-none"
            />
