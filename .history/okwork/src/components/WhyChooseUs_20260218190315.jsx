          ...
          <div className="w-full md:w-1/2 space-y-3 exo">
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-4 pt-">
               ...
               <button className="group relative px-6 py-4 bg-[#F15F25] text-xl text-white font-semibold rounded-xl float hover:shadow-xl hover:transform hover:-translate-y-1 transition-all duration-300 ease-in-out mt-10">
