...
const AboutUs = () => {
  ...
  return (
    <div className="max-w-7xl py-5 md:py-16 relative">
      ...
      <div className="absolute top-40 left-100 animate-pulse" id="anout">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center relative z-10 m-12">
        ...
        {/* Right content - No padding on right side */}
        <div className="lg:w-1/2 w-full space-y-6 exo ">
          {/* ^^^ Added pr-0 to remove right padding */}

          <span className="text-sm font-semibold text-white tracking-wider bg-[#6754E9] px-4 py-1.5 rounded-full inline-block">
            About Florawings
          </span>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-6 gap-x-10 pt-4">
            {[
              ...
              <div key={i} className="flex items-center gap-3">
                <div className="w-7 h-7 rounded-full bg-[#6C63FF] flex items-center justify-center flex-shrink-0">
