...
<div>
  {/* Button 1 - Gradient Design */}
<button 
 
  className="bg-gradient-to-r from-[#F15F25] to-[#ff8a5c] text-white px-8 py-3 rounded-full font-bold hover:from-[#d44e1e] hover:to-[#f15f25] transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 border-2 border-white/20"
>
  Get Franchise
</button>

{/* Button 2 - Outline Design */}
<button 
  
  className="bg-transparent text-[#F15F25] px-8 py-3 rounded-lg font-semibold hover:bg-[#F15F25] hover:text-white transition-all duration-300 border-2 border-[#F15F25] shadow-md hover:shadow-lg"
>
  Get Franchise
</button>
</div>
