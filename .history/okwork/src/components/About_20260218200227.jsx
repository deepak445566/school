...
// Import images
import aboutImage from '/public/imagesabout-1.png';
import aboutBG from '/public/imagesabout-bg-1.png';
import aboutCounter from '/public/imagesab-counter.png';
import bulbIcon from '/public/imagestubelight.png';
import starIcon from '/public/imagesstar.png';
import frame from '/public/imagesframe.png';
images
import program1 from '/public/imagesbook.png';
import program2 from '/public/imagesphone.png';
import program3 from '/public/imagesboy.png';
import program4 from '/public/imagescamical-book.png';

import top from "/public/imagestop-1.png";
import bot from "/public/imagesbottom-1.png";
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mt-20">
        ...
        {[ 
          ...
          <div
            key={i}
            className={`${card.bg} rounded-3xl p-8 text-center shadow-md relative overflow-hidden transition-all duration-500 ease-in-out hover:-translate-y-4 hover:shadow-xl`}
          >
            
            <img src={top} alt="" className="absolute top-0 left-0 w-16 opacity-60 pointer-events-none"/>
            <img src={bot} alt="" className="absolute bottom-0 right-0 w-16 opacity-60 pointer-events-none"/>

            <img src={card.img} alt="" className="w-20 mx-auto mb-4 relative z-10"/>

            <h3 className="text-xl font-semibold relative z-10">{card.title}</h3>
            <p className="text-gray-600 mb-4 relative z-10">{card.age}</p>

            <p className="text-gray-600 text-sm relative z-10">
              {card.desc}
            </p>

            <button className="mt-5 text-[#F15F25] font-semibold relative z-10">
              Learn More →
            </button>
          </div>
        ))}
