        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-col space-y-3 pt-2 text-black">
              ...
              <Lin href="founder" className=" hover:text-[#F15F25] transition-colors text-sm md:text-base flex items-center gap-2">
                <span className="text-[#F15F25] text-xs">▶</span> Founder Message
              </Lin>
              <Lin href="director" className=" hover:text-[#F15F25] transition-colors text-sm md:text-base flex items-center gap-2">
