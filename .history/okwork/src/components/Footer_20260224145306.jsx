        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3 pt-2">
              ...
              {/* YouTube */}
              <button 
                onClick={() => handleSocialClick('https://www.youtube.com/@florawings4915')}
        ...
        <div className="border-t border-gray-700 mt-8 md:mt-12 pt-6 md:pt-8 text-center text-black text-xs md:text-sm font-semibold">
          ...
          <button
            ...
            >
              ...
              <span className="font-bold bg-black bg-clip-text text-transparent group-hover:scale-105 transition-transform">
