          ...
          <div className="w-full md:w-1/2">
            <div className="grid grid-cols-2 gap-4 p-4">
              ...
              <div className="space-y-4">
                {/* Top left image */}
                <div className="relative overflow-hidden rounded-2xl transition-all duration-300 transform hover:-translate-y-1 z-10 relative">
                  <img
              ...
              <div className="relative overflow-hidden rounded-2xl transition-all duration-300 transform hover:-translate-y-1 z-100 absolute">
                <img
