              ...
              <div className="space-y-4">
                ...
                <div className="relative overflow-hidden rounded-2xl transition-all duration-300 transform hover:-translate-y-1">
                  <img
                    ...
                    className=" w-[100vw] lg:w-full h-48 object-cover"
                  />
                </div>
              </div>
              
              {/* Right column - 1 tall image */}
              <div className="relative overflow-hidden rounded-2xl transition-all duration-300 transform hover:-translate-y-1 hidden">
                <img
