      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16 md:h-20">
          ...
          <div className="hidden md:flex items-center gap-3">
            <button   onClick={() => window.location.href = 'tel:+919999995603'} className="bg-[#F15F25] text-white px-5 py-2.5 rounded-xl font-semibold hover:bg-[#d44e1e] transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
              Contact Us
            </button>
            <button onClick={handleenquiry} className="border-2 border-[#F15F25] text-[#F15F25] px-5 py-2.5 rounded-xl font-semibold hover:bg-[#F15F25] hover:text-white transition-all duration-300 shadow-md hover:shadow-lg transform hover:-translate-y-0.5">
              Get Franchise
            </button>
          </div>
...
>
  ...
  Call Us: +91 99999 95603
            ...
            <button onClick={handleenquiry} className="w-full border-2 border-[#F15F25] text-[#F15F25] px-5 py-3 rounded-xl font-semibold hover:bg-[#F15F25] hover:text-white transition-colors duration-300 shadow-md">
              Get Franchise
            </button>
          </div>
        </div>
