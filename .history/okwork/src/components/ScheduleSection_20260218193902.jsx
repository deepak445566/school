...
const ScheduleSection = () => {
  return (
    <>
    <div className="h-[90vh] bg-[#FFE800] overflow-hidden exo py-12 md:py-16 lg:py-20 relative ">
     ...
     <div className="">
        <img src="/images/newsletter1.png" alt="Newsletter" className="w-full h-[20vh] object-cover" />
      </div>
      </>
  );
};
