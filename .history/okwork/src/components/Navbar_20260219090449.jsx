...
const Navbar = () => {
  ...
  className="w-full bg-[#F15F25] text-white px-5 py-2 rounded-xl font-semibold hover:bg-[#d44e1e] transition-colors duration-300 shadow-md flex items-center justify-center gap-2"
>
