      ...
      <div className="container mx-auto px-6 md:px-12 lg:px-10">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full md:w-1/2 relative">
            ...
            <div>
             <img
                src="/images/coun-shape.png"
                alt="Decorative element"
                className="absolute top-0 -right-5 lg:right-7  z-20 w-13 h-13 md:w-15 md:h-15 object-contain -translate-x-4 -translate-y-4 animate-bounce-slow "
              />
            </div>
          </div>
          
          {/* RIGHT SECTION - Content (same as before) */}
          <div className="w-full md:w-1/2 space-y-3 exo relative">
            {/* Small heading */}
            ...
            <div className="space-y-4 pt-4">
              ...
              <div className="space-y-4 pt-">
               ...
               <button className="group relative px-6 py-3 bg-[#F15F25] text-xl text-white  rounded-xl float hover:shadow-xl hover:transform hover:-translate-y-1 transition-all duration-300 ease-in-out mt-10">
            ...
            <div>
              <img
                ...
                alt="Decorative element"
                className="absolute -bottom-6 -right-5 lg:right-7  z-20 w-17 h-17 md:w-25 md:h-25 object-contain -translate-x-4 -translate-y-4 animate-bounce-slow "
              />
            </div>
          </div>
       ...
       <div className=" absolute bottom-3  z-1000">
