    ...
    <div className="min-h-screen bg-[#F7FAE2] overflow-hidden exo py-16">
      <div className="container mx-auto px-6 md:px-12 lg:px-10">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-16">
          ...
          <div className="w-full md:w-1/2 rea">
            ...
            <div>
             <img
                ...
                className="absolute top-0 left-7 lg:left-0 z-20 w-24 h-24 md:w-52 md:h-52 object-contain -translate-x-4 -translate-y-4 animate-bounce-slow "
              />
            </div>
          </div>
