...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F7FAE2] overflow-hidden exo rea ">
      {/* Main container - centered with responsive padding */}
      <div className="container mx-auto px-6 py-12 md:px-12 lg:px-10 min-h-screen flex items-center relative z-10">
...
most young for your children life.
        ...
        <div className=" absolute bottom-  z-1000">
