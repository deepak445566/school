    ...
    <div className="min-h-screen bg-white overflow-hidden exo py-8 sm:py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 xl:px-12">
        ...
        <div className="text-center mb-6 sm:mb-8 md:mb-10 lg:mb-12">
          <h2 className="text-[#F15F25] text-sm sm:text-base md:text-lg lg:text-xl font-semibold uppercase tracking-wider mb-1 sm:mb-2">
            Our Team
          </h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5 lg:gap-6">
          {teachers.map((teacher, index) => (
            <div key={index} className="flex flex-col">
              ...
              <div className="group relative bg-white rounded-xl sm:rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-all duration-300">
                <div className="relative overflow-hidden aspect-square">
                  <img
                    src={teacher.image}
                    alt={teacher.name}
                    className="w-full h-full object-cover hover:transition-y-5 duration-500"
                  />
