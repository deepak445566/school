...
const Navbar = () => {
  ...
  className="w-full bg-[#F15F25] text-white px-3 py-3 rounded-xl font-semibold hover:bg-[#d44e1e] transition-colors duration-300 shadow-md flex items-center justify-center gap-2"
>
