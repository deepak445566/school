            ...
            <div className="grid grid-cols-2 gap-4 p-4">
              ...
              <div className="space-y-4">
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <img
                    src="/images/pinterest-1.jpg" // Replace with your image path
                ...
                <div className="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                  <img
                    src="/images/pinterest-2.jpg" // Replace with your image path
              ...
              <div className="relative overflow-hidden rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                <img
                  src="/images/pinterest-3.jpg" // Replace with your image path
