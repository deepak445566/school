...
>
  ...
  Call Us: +91 99999 95603
            ...
            <button onClick={} className="w-full border-2 border-[#F15F25] text-[#F15F25] px-5 py-3 rounded-xl font-semibold hover:bg-[#F15F25] hover:text-white transition-colors duration-300 shadow-md">
              Get Franchise
            </button>
          </div>
        </div>
