  ...
  return (
    <div className="min-h-screen bg-[#F7FAE2] overflow-hidden exo">
      ...
      <div className="container mx-auto px-6 py-12 md:px-12 lg:px-10 min-h-screen flex items-center">
        ...
        <div className="flex flex-col md:flex-row items-center gap-12 lg:gap-10 w-full">
          
          {/* LEFT SECTION: Heading, Paragraph, Button */}
          <div className="flex-1 text-center md:text-left space-y-6 md:space-y-6">
...
most young for your children life.
            ...
            <div className="flex justify-center md:justify-start">
              <button className="group relative px-8 py-4 bg-[#F15F25] text-white font-semibold rounded-xl shadow-lg shadow-blue-200 hover:shadow-xl hover:transform hover:-translate-y-1 transition-all duration-300 ease-in-out">
          ...
          <div className="flex-1 flex justify-center md:justify-end bg-red-400">
