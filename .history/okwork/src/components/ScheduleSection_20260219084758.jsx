  ...
  return (
    ...
    <div className="min-h-screen bg-[#FFE800] overflow-hidden exo py-12 md:py-16 lg:py-20 relative ">
       <div className=" absolute bottom-0  z-1000">
          <img src="/images/footerok.png" className="w-full"/>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <p className="text-gray-600 text-base md:text-lg max-w-lg mx-auto lg:mx-0">
             Our school session begins at 8:00 AM and ends at 4:00 PM. Students are expected to arrive on time. Regular classes, activities, and short breaks are scheduled within this time.
            </p>
          </div>
