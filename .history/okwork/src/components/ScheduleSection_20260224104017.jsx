...
const ScheduleSection = () => {
  // 8 photos for Pinterest-style gallery
  const galleryImages = [
    {
      id: 1,
  ...
  return (
    <>
      ...
      <div className="bg-[#FEDB1C] overflow-hidden exo relative " style={{ height: '80vh' }}>
        ...
        <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 relative z-10 h-full">
          
          {/* Main Flex Container - Only Gallery */}
          <div className="flex justify-center items-center h-full">
            
            {/* Pinterest Style Gallery - Full Width */}
      ...
      {/* Optional: Add scrollbar hide style */}
      <style jsx>{`
