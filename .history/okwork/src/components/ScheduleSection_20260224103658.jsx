          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 xl:gap-16">
            ...
            <div className="lg:w-1/3 space-y-4 md:space-y-6">
              ...
              <p className="text-base md:text-lg text-gray-800">
                Discover our upcoming events and activities. Join us for exciting
                sessions and make the most of your time with us.
              </p>
              <button className="bg-[#F15F25] text-white px-6 py-3 rounded-lg hover:bg-[#d44d1c] transition-colors duration-300">
                View Full Schedule
              </button>
            </div>
