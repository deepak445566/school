...
const ProgramSection = () => {
  ...
  },
  {
    ...
    bg: "bg-[#FFE5B4]",
    desc: "Comprehensive teacher training with Montessori methods, classroom management, and child psychology.",
    icon: "👩‍🏫",
    color: "from-[#FFE5B4] to-[#ffd699]",
    features: ["Montessori Certified", "Practical Training", "Placement Support"]
  },
  {
    img: program6, // You'll need to add this image import
    title: "Day Care",
    age: "(6 months - 6 years)",
    bg: "bg-[#C4E6F1]",
    desc: "Safe, nurturing environment with structured activities, nap time, meals, and supervised play.",
    icon: "🍼",
    color: "from-[#C4E6F1] to-[#a8d4e0]",
    features: ["Flexible Hours", "Nutritious Meals", "Activity Based"]
  },
  {
    img: program7, // You'll need to add this image import
    title: "After School Learning",
    age: "(Class 1–8)",
    bg: "bg-[#E6D5B8]",
    desc: "Homework assistance, skill development, creative activities, and personality enhancement programs.",
    icon: "📝",
    color: "from-[#E6D5B8] to-[#d4c2a5]",
    features: ["Homework Help", "Skill Classes", "Creative Activities"]
  }
].map((card, i) => (
