...
const ScheduleSection = () => {
  return (
    <>
    <div className="min-h-screen bg-[#6754E9] overflow-hidden exo py-12 md:py-16 lg:py-20 relative ">
       <div className=" absolute top-0  z-1000">
          <img src="/images/header1.png" className="w-full"/>
        </div>
      
      {/* Background Light Effects */}
      <div className="absolute left-0 top-1/2 -translate-y-1/2 w-64 md:w-96 h-64 md:h-96 bg-[#6754E9]/10 rounded-full blur-3xl"></div>
      <div className="absolute right-0 top-1/2 -translate-y-1/2 w-64 md:w-96 h-64 md:h-96 bg-[#6754E9]/10 rounded-full blur-3xl"></div>
      ...
      <div className="container mx-auto px-4 sm:px-6 md:px-8 lg:px-10 xl:px-12 relative z-10">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-10 lg:gap-16">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            <h2 className="text-black text-lg md:text-xl font-semibold uppercase tracking-wider mb-3">
              Session Times
            </h2>
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-gray-800 mb-4 leading-tight">
              Our session Times
            </h1>
            <p className="text-black text-base md:text-lg max-w-lg mx-auto lg:mx-0">
