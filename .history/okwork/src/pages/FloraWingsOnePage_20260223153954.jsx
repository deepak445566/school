        ...
        <div className="relative max-w-6xl mx-auto px-4 py-16 md:py-24">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mt-12">
            <button
              ...
              className="bg-[#F15F25] text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-[#d44e1e] transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105 flex items-center justify-center gap-2 border-2 border-white/30"
            >
            ...
            <button
              onClick={handleEnquiry}
              className="bg-white text-[#F15F25] px-8 py-4 rounded-full font-bold text-lg hover:bg-[#F15F25] hover:text-white transition-all duration-300 shadow-xl border-2 border-[#F15F25] flex items-center justify-center gap-2"
            >
              <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto py-16 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 text-center bg-gradient-to-r from-amber-100 to-blue-100 rounded-3xl p-10 border border-amber-200">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <button
              onClick={handleEnquiry}
              className="bg-[#F15F25] text-white px-10 py-4 rounded-full font-bold text-lg hover:bg-[#d44e1e] transition-all duration-300 shadow-xl hover:shadow-2xl transform hover:scale-105"
            >
              Claim Your Franchise Now
            </button>
            
            <button
              onClick={handleEnquiry}
              className="bg-white text-[#F15F25] px-10 py-4 rounded-full font-bold text-lg hover:bg-[#F15F25] hover:text-white transition-all duration-300 shadow-xl border-2 border-[#F15F25]"
            >
              Enroll Your Child
            </button>
          </div>
      ...
      {showEnquiryForm && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl max-w-md w-full p-8 relative animate-fadeIn">
            ...
            <h3 className="text-2xl font-bold text-stone-800 mb-6">Enquiry Form</h3>
            ...
            <form onSubmit={submitEnquiry} className="space-y-4">
              <div>
                ...
                <input 
                  type="text" 
                  required
                  className="w-full px-4 py-2 border border-stone-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F15F25]"
                />
              </div>
              ...
              <div>
                ...
                <select className="w-full px-4 py-2 border border-stone-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#F15F25]">
              ...
              <button
                type="submit"
                className="w-full bg-[#F15F25] text-white px-6 py-3 rounded-lg font-semibold hover:bg-[#d44e1e] transition-colors"
              >
                Submit Enquiry
              </button>
            </form>
