  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          access_key: 'b98bd3f6-2eb5-47a3-b757-984057fc985f', // Tumhara access key
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 p-6 bg-gray-50 border-b">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="font-semibold">State Government</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#F15F25]/10 rounded-full flex items-center justify-center">
              ...
              <div>
                ...
                <p className="font-semibold text-sm"> I-642, street no -6 East Jawahar. Nagar Loni Shiv Vihar, Loni, Ghaziabad UP</p>
              </div>
            </div>
          </div>
        </div>
