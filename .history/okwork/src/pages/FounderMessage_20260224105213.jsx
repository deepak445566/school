 ...
 <div className="flex flex-col sm:flex-row gap-4 mb-8 justify-center">
          ...
          <div className="mt-8 sm:mt-12 pt-6 sm:pt-8 border-t-2 border-dashed border-amber-200 flex flex-col lg:flex-row lg:items-end lg:justify-between gap-6">
            ...
            <div className="relative flex items-center gap-4">
              <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-amber-200 to-emerald-200 flex items-center justify-center border-4 border-white shadow-xl">
                <svg className="w-8 h-8 sm:w-10 sm:h-10 text-emerald-700" fill="currentColor" viewBox="0 0 24 24">
